...
namespace Gaskellgames.EditorOnly
{
    ...
    public class GgEditorCallbacks : AssetPostprocessor, ISerializationCallbackReceiver
    {
        ...
        public delegate void OnGameObjectDestroyedDelegate(EntityId instanceID, GameObject parent, Scene scene);
        ...
        public delegate void OnAssetObjectDestroyedDelegate(EntityId instanceID, string guid);
        ...
        private static Object EntityIdToObject(EntityId instanceID)
        {
        ...
        private static void ObjectChangeEvents_CreateGameObjectHierarchy(ref ObjectChangeEventStream stream, int index)
        {
            ...
            GameObject newGameObject = EntityIdToObject(createGameObjectHierarchyEvent.entityId) as GameObject;
        ...
        private static void ObjectChangeEvents_DestroyGameObjectHierarchy(ref ObjectChangeEventStream stream, int index)
        {
            ...
            GameObject destroyParentGo = EntityIdToObject(destroyGameObjectHierarchyEvent.parentEntityId) as GameObject;
            
            DebugLog("OnGameObjectDestroyed: {0} in scene {1} with parent {2}", destroyGameObjectHierarchyEvent.entityId, destroyGameObjectHierarchyEvent.scene.name, destroyParentGo ? destroyParentGo.name : "Root");
            OnGameObjectDestroyed?.Invoke(destroyGameObjectHierarchyEvent.entityId, destroyParentGo, destroyGameObjectHierarchyEvent.scene);
        }
        ...
        private static void ObjectChangeEvents_ChangeGameObjectStructureHierarchy(ref ObjectChangeEventStream stream, int index)
        {
            ...
            GameObject gameObject = EntityIdToObject(changeGameObjectStructureHierarchy.entityId) as GameObject;
        ...
        private static void ObjectChangeEvents_ChangeGameObjectStructure(ref ObjectChangeEventStream stream, int index)
        {
            ...
            GameObject gameObjectStructure = EntityIdToObject(changeGameObjectStructure.entityId) as GameObject;
        ...
        private static void ObjectChangeEvents_ChangeGameObjectParent(ref ObjectChangeEventStream stream, int index)
        {
            ...
            GameObject gameObjectChanged = EntityIdToObject(changeGameObjectParent.entityId) as GameObject;
            GameObject newParentGo = EntityIdToObject(changeGameObjectParent.newParentEntityId) as GameObject;
            GameObject previousParentGo = EntityIdToObject(changeGameObjectParent.previousParentEntityId) as GameObject;
        ...
        private static void ObjectChangeEvents_ChangeGameObjectOrComponentProperties(ref ObjectChangeEventStream stream, int index)
        {
            ...
            Object goOrComponent = EntityIdToObject(changeGameObjectOrComponent.entityId);
        ...
        private static void ObjectChangeEvents_CreateAssetObject(ref ObjectChangeEventStream stream, int index)
        {
            ...
            Object createdAsset = EntityIdToObject(createAssetObjectEvent.entityId);
        ...
        private static void ObjectChangeEvents_DestroyAssetObject(ref ObjectChangeEventStream stream, int index)
        {
            ...
            DebugLog("OnAssetObjectDestroyed: {0}", destroyAssetObjectEvent.entityId);
            OnAssetObjectDestroyed?.Invoke(destroyAssetObjectEvent.entityId, destroyAssetObjectEvent.guid.ToString());
        }
        ...
        private static void ObjectChangeEvents_ChangeAssetObjectProperties(ref ObjectChangeEventStream stream, int index)
        {
            ...
            Object changeAsset = EntityIdToObject(changeAssetObjectPropertiesEvent.entityId);
        ...
        private static void ObjectChangeEvents_UpdatePrefabInstances(ref ObjectChangeEventStream stream, int index)
        {
            ...
            foreach (EntityId instanceID in updatePrefabInstancesEvent.entityIds)
            {
                GameObject prefabRoot = EntityIdToObject(instanceID) as GameObject;
