...
namespace Gaskellgames.EditorOnly
{
    ...
    public static class HierarchyUtility
    {
        ...
        private static Dictionary<EntityId, HierarchyData> hierarchyObjectCache;
        ...
        private static void Initialisation()
        {
            ...
            EditorApplication.hierarchyWindowItemByEntityIdOnGUI -= DrawHierarchy;
            ...
            // initialise cache
            hierarchyObjectCache = new Dictionary<EntityId, HierarchyData>();
        ...
        private static void OnGameObjectDestroyed(EntityId instanceID, GameObject parent, Scene scene)
        {
            if (!GaskellgamesSettings_SO.Instance) { return; }
            if (!GaskellgamesSettings_SO.Instance.ShowHierarchyIcons && !GaskellgamesSettings_SO.Instance.ShowHierarchyBreadcrumbs) { return; }
            if (!parent) { return; }
        ...
        private static void OnGameObjectStructureUpdated(GameObject gameObject)
        {
            ...
            if (hierarchyObjectCache.TryGetValue(gameObject.GetEntityId(), out HierarchyData hierarchyData))
            {
        ...
        private static void DrawHierarchy(EntityId instanceID, Rect position)
        {
        ...
        private static void CacheParentOrSelfRecursive(Transform transform, Scene scene)
        {
            ...
            EntityId parentID = transform.parent.gameObject.GetEntityId();
        ...
        private static void DrawHierarchyComponentIcons(EntityId instanceID, Rect position)
        {
            if (!GaskellgamesSettings_SO.Instance) { return; }
        ...
        /// <param name="instanceID"></param>
        /// <param name="position"></param>
        private static void DrawHierarchyBreadcrumbs(EntityId instanceID, Rect position)
        {
            if (!GaskellgamesSettings_SO.Instance) { return; }
