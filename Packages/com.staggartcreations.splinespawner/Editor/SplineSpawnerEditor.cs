...
namespace sc.splines.spawner.editor
{
    public static class SplineSpawnerEditor
    {
        ...
        private static void OnMaskToggle(SplineSpawnerMask instance, bool enabled)
        {
            ...
            if (Application.isPlaying == false && Application.isBatchMode == false && BuildPipeline.isBuildingPlayer == false)
            {
        ...
        private class PrefabDataPopupWindow : EditorWindow
        {
            ...
            public static void Show(Rect rect, SplineSpawner.SpawnableObject prefab)
            {
                ...
                Vector2 size = new Vector2(200, 250);
            ...
            private void OnGUI()
            {
                ...
                EditorGUILayout.LabelField($"Radius: {_prefabData.GetRadiusXZ()}");
